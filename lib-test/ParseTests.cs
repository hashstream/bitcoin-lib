...
namespace lib_test
{
    public class ParseTests
    {
...
#if NETCOREAPP2_1
            block_parsed.ReadFromPayload(block.FromHex());
#else
        ...
        public void Script_Witness_Verify()
        {
...
#if NETCOREAPP2_1
            prev_tx_parsed.ReadFromPayload(prev_tx); //vout 8 in this case for the below tx
#else
            ...
            var tx_parsed = new Tx();
#if NETCOREAPP2_1
            tx_parsed.ReadFromPayload(tx.AsSpan());
#else
            tx_parsed.ReadFromPayload(tx, 0);
#endif
        }
